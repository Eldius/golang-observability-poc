module github.com/eldius/golang-observability-poc/rest-service-a

go 1.22.5

require (
	github.com/eldius/golang-observability-poc/otel-instrumentation-helper v0.0.0-20240718032402-fbe92e9146d6
